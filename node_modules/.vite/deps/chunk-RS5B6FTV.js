  ...
  "../../node_modules/@mui/system/createStyled.js"(exports) {
    ...
    function processStyleArg2(callableStyle, _ref) {
      ...
      if (!!resolvedStylesArg && typeof resolvedStylesArg === "object" && Array.isArray(resolvedStylesArg.variants)) {
        const {
          variants = []
        } = resolvedStylesArg, otherStyles = (0, _objectWithoutPropertiesLoose2.default)(resolvedStylesArg, _excluded24);
...
var _excluded19 = ["localeText"];
var MuiPickersAdapterContext = React37.createContext(null);
if (true) {
...
var LocalizationProvider = function LocalizationProvider2(inProps) {
  ...
  } = inProps, otherInProps = _objectWithoutPropertiesLoose(inProps, _excluded19);
  const {
    utils: parentUtils,
    localeText: parentLocaleText
  } = React37.useContext(MuiPickersAdapterContext) ?? {
    utils: void 0,
    localeText: void 0
  };
  ...
  const localeText = React37.useMemo(() => _extends({}, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
  const utils = React37.useMemo(() => {
    if (!DateAdapter) {
      if (parentUtils) {
        return parentUtils;
      }
...
`));
  ...
  const defaultDates = React37.useMemo(() => {
    if (!utils) {
      return null;
    }
    return {
  ...
  return (0, import_jsx_runtime17.jsx)(MuiPickersAdapterContext.Provider, {
    value: contextValue,
    children
  });
};
true ? LocalizationProvider.propTypes = {
   ...
   */
  adapterLocale: import_prop_types22.default.any,
  children: import_prop_types22.default.node,
  /**
   * Date library adapter class function.
   * @see See the localization provider {@link https://mui.com/x/react-date-pickers/getting-started/#setup-your-date-library-adapter date adapter setup section} for more details.
   */
  dateAdapter: import_prop_types22.default.func,
  /**
   * Formats that are used for any child pickers
   */
  dateFormats: import_prop_types22.default.shape({
    dayOfMonth: import_prop_types22.default.string,
    dayOfMonthFull: import_prop_types22.default.string,
    fullDate: import_prop_types22.default.string,
    fullTime: import_prop_types22.default.string,
    fullTime12h: import_prop_types22.default.string,
    fullTime24h: import_prop_types22.default.string,
    hours12h: import_prop_types22.default.string,
    hours24h: import_prop_types22.default.string,
    keyboardDate: import_prop_types22.default.string,
    keyboardDateTime: import_prop_types22.default.string,
    keyboardDateTime12h: import_prop_types22.default.string,
    keyboardDateTime24h: import_prop_types22.default.string,
    meridiem: import_prop_types22.default.string,
    minutes: import_prop_types22.default.string,
    month: import_prop_types22.default.string,
    monthShort: import_prop_types22.default.string,
    normalDate: import_prop_types22.default.string,
    normalDateWithWeekday: import_prop_types22.default.string,
    seconds: import_prop_types22.default.string,
    shortDate: import_prop_types22.default.string,
    weekday: import_prop_types22.default.string,
    weekdayShort: import_prop_types22.default.string,
    year: import_prop_types22.default.string
  }),
  /**
   ...
   * ```
   */
  dateLibInstance: import_prop_types22.default.any,
  /**
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RS5B6FTV.js.map
