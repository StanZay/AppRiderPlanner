...
import "./chunk-REM5BIPA.js";
import {
  useThemeProps
} from "./chunk-CBZUZQ6L.js";
import "./chunk-6VWAHX6D.js";
import "./chunk-FMFFUJ5P.js";
import "./chunk-VKCM4YSD.js";
import "./chunk-SPMXLTKB.js";
import {
...
import "./chunk-HMPUWN6T.js";
import "./chunk-GWH63OPR.js";
import "./chunk-VVE2DVEA.js";
import {
  composeClasses,
...
function ChartsGrid(props) {
  ...
  return (0, import_jsx_runtime5.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
...
function ChartsVoronoiHandler(props) {
  ...
  const voronoiRef = React6.useRef({});
  const delauneyRef = React6.useRef(void 0);
  const lastFind = React6.useRef(void 0);
  const {
    setHighlighted,
    clearHighlighted
  } = useHighlighted();
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime13.jsxs)(React13.Fragment, {
    children: [maskTransition((style, {
      ...
      return (0, import_jsx_runtime13.jsx)(BarClipPath, {
        maskId: id,
        borderRadius,
        hasNegative,
        hasPositive,
      ...
      const barElement = (0, import_jsx_runtime13.jsx)(BarElement, _extends({
        id: seriesId,
        dataIndex,
        color: color2
      }, other, {
    ...
    }), barLabel && (0, import_jsx_runtime13.jsx)(BarLabelPlot, _extends({
      bars: completedData,
      skipAnimation,
      barLabel
    }, other))]
...
var BarChart = React14.forwardRef(function BarChart2(props, ref) {
  const {
    chartContainerProps,
    barPlotProps,
    axisClickHandlerProps,
  ...
  return (0, import_jsx_runtime14.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime14.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime14.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime14.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime14.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime14.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime14.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime14.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime14.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime14.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime14.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
...
var useAnimatedPath = (path, skipAnimation) => {
  ...
  const interpolator = React15.useMemo(() => previousPath ? string_default(previousPath, path) : () => path, [previousPath, path]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime15.jsxs)(React16.Fragment, {
    children: [(0, import_jsx_runtime15.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime15.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      })
    }), (0, import_jsx_runtime15.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime15.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path
      }))
    })]
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(Area, _extends({}, other, areaProps));
}
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime17.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime17.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime18.jsxs)(React19.Fragment, {
    children: [(0, import_jsx_runtime18.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime18.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      })
    }), (0, import_jsx_runtime18.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime18.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path
      }))
    })]
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(Line, _extends({}, other, lineProps));
}
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime20.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime20.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var _excluded15 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation"];
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
var _excluded16 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
function MarkPlot(props) {
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  return (0, import_jsx_runtime22.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime22.jsx)("g", {
          clipPath: `url(#${clipId})`,
          children: xData == null ? void 0 : xData.map((x, index) => {
            ...
            return (0, import_jsx_runtime22.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index,
              shape: "circle",
...
var _excluded17 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
...
function LineHighlightPlot(props) {
  ...
  return (0, import_jsx_runtime24.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ids: groupIds
    }) => {
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime24.jsx)(Element, _extends({
          id: seriesId,
...
var LineChart = React26.forwardRef(function LineChart2(props, ref) {
  const {
    chartContainerProps,
    axisClickHandlerProps,
    gridProps,
  ...
  return (0, import_jsx_runtime25.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime25.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime25.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime25.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime25.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime25.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime25.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime25.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime25.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime25.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime25.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime25.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime25.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime25.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime25.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   */
  disableLineItemHighlight: import_prop_types21.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types21.default.shape({
   ...
   */
  onAreaClick: import_prop_types21.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   * @param {null | AxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types21.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   ...
   */
  onLineClick: import_prop_types21.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types21.default.func,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
...
function Scatter(props) {
  ...
  const cleanData = React27.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const temp = [];
  ...
  return (0, import_jsx_runtime26.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime26.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
true ? Scatter.propTypes = {
  ...
  colorGetter: import_prop_types22.default.func,
  markerSize: import_prop_types22.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  series: import_prop_types22.default.object.isRequired,
  xScale: import_prop_types22.default.func.isRequired,
  yScale: import_prop_types22.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(React28.Fragment, {
    children: seriesOrder.map((seriesId) => {
      ...
      const xScale = xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime27.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
        colorGetter,
...
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded20 = ["xAxis", "yAxis", "zAxis", "series", "tooltip", "axisHighlight", "voronoiMaxRadius", "disableVoronoi", "legend", "width", "height", "margin", "colors", "sx", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "onItemClick", "children", "slots", "slotProps", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var ScatterChart = React29.forwardRef(function ScatterChart2(props, ref) {
  const {
    chartContainerProps,
    zAxisProps,
    voronoiHandlerProps,
  ...
  return (0, import_jsx_runtime28.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime28.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime28.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime28.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), props.grid && (0, import_jsx_runtime28.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime28.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime28.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime28.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime28.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime28.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime28.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
true ? ScatterChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types24.default.oneOfType([import_prop_types24.default.object, import_prop_types24.default.string]),
   ...
   * @default false
   */
  disableVoronoi: import_prop_types24.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types24.default.shape({
    horizontal: import_prop_types24.default.bool,
    vertical: import_prop_types24.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types24.default.oneOfType([import_prop_types24.default.object, import_prop_types24.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
   ...
   * @default null
   */
  rightAxis: import_prop_types24.default.oneOfType([import_prop_types24.default.object, import_prop_types24.default.string]),
  /**
   ...
   * @default null
   */
  topAxis: import_prop_types24.default.oneOfType([import_prop_types24.default.object, import_prop_types24.default.string]),
   ...
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types24.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types24.default.number,
...
var _excluded21 = ["xAxis", "yAxis", "width", "height", "margin", "colors", "sx", "showTooltip", "tooltip", "showHighlight", "axisHighlight", "children", "slots", "slotProps", "data", "plotType", "valueFormatter", "area", "curve", "className"];
...
var SparkLineChart = React30.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    width,
  ...
  return (0, import_jsx_runtime29.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime29.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps,
      sx: {
    ...
    }), plotType === "line" && (0, import_jsx_runtime29.jsxs)(React30.Fragment, {
      children: [(0, import_jsx_runtime29.jsx)(AreaPlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime29.jsx)(LinePlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime29.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime29.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime29.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  }));
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types25.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types25.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types25.default.arrayOf(import_prop_types25.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types25.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types25.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types25.default.bool,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   */
  xAxis: import_prop_types25.default.shape({
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types25.default.shape({
    axisId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]),
    classes: import_prop_types25.default.object,
    colorMap: import_prop_types25.default.oneOfType([import_prop_types25.default.shape({
      colors: import_prop_types25.default.arrayOf(import_prop_types25.default.string).isRequired,
...
var GaugeContext = React31.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
function useGaugeState() {
  return React31.useContext(GaugeContext);
}

// node_modules/@mui/x-charts/esm/Gauge/GaugeContainer.js
var import_jsx_runtime31 = __toESM(require_jsx_runtime());
var _excluded23 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var GaugeContainer = React32.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  return (0, import_jsx_runtime31.jsx)(ResizableContainer, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime31.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime31.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime31.jsx)(ChartsSurface, {
          width,
          height,
          ref: chartSurfaceRef,
          title,
...
true ? GaugeContainer.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.string]),
   ...
   * @default 360
   */
  endAngle: import_prop_types26.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types26.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types26.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types26.default.number,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
var _excluded24 = ["text", "className"];
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime34.jsx)("g", {
    className,
    children: (0, import_jsx_runtime34.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
true ? GaugeValueText.propTypes = {
   ...
   */
  lineHeight: import_prop_types27.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types27.default.bool,
  ownerState: import_prop_types27.default.any,
  /**
   * Style applied to text elements.
   */
  style: import_prop_types27.default.object,
  text: import_prop_types27.default.oneOfType([import_prop_types27.default.func, import_prop_types27.default.string])
} : void 0;

// node_modules/@mui/x-charts/esm/Gauge/Gauge.js
var import_jsx_runtime35 = __toESM(require_jsx_runtime());
var _excluded25 = ["text", "children", "classes", "className"];
...
var Gauge = React36.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className
  ...
  return (0, import_jsx_runtime35.jsxs)(GaugeContainer, _extends({}, other, {
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime35.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime35.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime35.jsx)(GaugeValueText, {
...
true ? Gauge.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
  desc: import_prop_types28.default.string,
  /**
   * If `true`, the charts will not listen to the mouse move event.
   * It might break interactive features, but will improve performance.
   * @default false
   */
  disableAxisListener: import_prop_types28.default.bool,
  /**
   * The end angle (deg).
   * @default 360
   */
  endAngle: import_prop_types28.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
  height: import_prop_types28.default.number,
  /**
   * The radius between circle center and the beginning of the arc.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the maximal radius that fit into the drawing area.
   * @default '80%'
   */
  innerRadius: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   * @default object Depends on the charts type.
   */
  margin: import_prop_types28.default.shape({
    bottom: import_prop_types28.default.number,
    left: import_prop_types28.default.number,
    right: import_prop_types28.default.number,
    top: import_prop_types28.default.number
  }),
  /**
   * The radius between circle center and the end of the arc.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types28.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types28.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types28.default.number,
  viewBox: import_prop_types28.default.shape({
    height: import_prop_types28.default.number,
    width: import_prop_types28.default.number,
    x: import_prop_types28.default.number,
    y: import_prop_types28.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
