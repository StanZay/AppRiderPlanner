...
var Splitter = React4.memo(React4.forwardRef(function(inProps, ref) {
  ...
  var idState = React4.useRef("");
  var elementRef = React4.useRef(null);
  var gutterRef = React4.useRef();
  var gutterRefs = React4.useRef({});
  var size = React4.useRef(null);
  var dragging = React4.useRef(null);
  var startPos = React4.useRef(null);
  var prevPanelElement = React4.useRef(null);
  var nextPanelElement = React4.useRef(null);
  var prevPanelSize = React4.useRef(null);
  var prevSize = React4.useRef(null);
  var prevPanelSizeNew = React4.useRef(null);
  var nextPanelSize = React4.useRef(null);
  var nextPanelSizeNew = React4.useRef(null);
  var prevPanelIndex = React4.useRef(null);
  var timer = React4.useRef(null);
  var _React$useState = React4.useState([]), _React$useState2 = _slicedToArray3(_React$useState, 2), panelSizes = _React$useState2[0], setPanelSizes = _React$useState2[1];
  var _React$useState3 = React4.useState(false), _React$useState4 = _slicedToArray3(_React$useState3, 2), nested = _React$useState4[0], setNested = _React$useState4[1];
  ...
  var _SplitterBase$setMeta = SplitterBase.setMetaData(_objectSpread3({}, metaData)), ptm = _SplitterBase$setMeta.ptm, cx = _SplitterBase$setMeta.cx, isUnstyled = _SplitterBase$setMeta.isUnstyled;
  ...
  var getStorage = React4.useCallback(function() {
  ...
  var restoreState = React4.useCallback(function() {
  ...
  var onResizeEnd = function onResizeEnd2(event) {
    var sizes = _toConsumableArray3(panelSizes);
  ...
  var onGutterTouchEnd = function onGutterTouchEnd2(event) {
    onResizeEnd(event);
  ...
  React4.useEffect(function() {
    var panelElements = _toConsumableArray3(elementRef.current.children).filter(function(child) {
  ...
  var createPanel = function createPanel2(panel, index) {
    ...
    var gutterHandlerProps = mergeProps2({
    ...
    var gutter = index !== props.children.length - 1 && React4.createElement("div", gutterProps, React4.createElement("div", gutterHandlerProps));
    var flexBasis = "calc(" + panelSize(panelSizes, index) + "% - " + (childrenLength - 1) * props.gutterSize + "px)";
    var rootProps2 = mergeProps2({
      key: index,
      id: panelId,
      className: panelClassName,
      style: _objectSpread3(_objectSpread3({}, getPanelProp(panel, "style")), {}, {
        flexBasis
      }),
      role: "presentation",
      "data-p-splitter-panel-nested": false
    }, getPanelPT("splitterpanel.root"));
    return React4.createElement(React4.Fragment, null, React4.createElement("div", rootProps2, getPanelProp(panel, "children")), gutter);
  };
  var createPanels = function createPanels2() {
    return React4.Children.map(props.children, createPanel);
  };
...
//# sourceMappingURL=primereact_splitter.js.map
