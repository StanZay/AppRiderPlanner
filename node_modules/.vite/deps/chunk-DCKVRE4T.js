import {
  ...
  useSvgRef,
  useTicks
} from "./chunk-Y675OU5I.js";
import {
  createPopper,
  useClassNamesOverride,
  useSlotProps
} from "./chunk-ZB3DIDKD.js";
import {
  Typography_default
} from "./chunk-SOXEVPGS.js";
import {
  appearance_default,
  arc_default,
  ascending_default,
...
import {
  useThemeProps
} from "./chunk-RHCKV7AJ.js";
import {
  useTheme
} from "./chunk-3ONDKOZI.js";
import {
  shouldForwardProp
} from "./chunk-UQRTQNS3.js";
import {
  require_react_dom
...
function ChartsText(props) {
  ...
  return (0, import_jsx_runtime10.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index) => (0, import_jsx_runtime10.jsx)("tspan", {
      x,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime13.jsxs)(React24.Fragment, {
...
var Portal = React25.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime14.jsx)(React25.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime14.jsx)(React25.Fragment, {
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(React27.Fragment, {
  ...
  return (0, import_jsx_runtime17.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime17.jsx)(ChartsTooltipTable, {
      ...
      children: (0, import_jsx_runtime17.jsx)("tbody", {
        children: (0, import_jsx_runtime17.jsxs)(ChartsTooltipRow, {
...
function useColorProcessor(seriesType) {
  const colorProcessors = React30.useContext(ColorContext);
  if (!seriesType) {
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime19.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime19.jsx)("thead", {
        children: (0, import_jsx_runtime19.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime19.jsx)(ChartsTooltipCell, {
            colSpan: 3,
            children: (0, import_jsx_runtime19.jsx)(Typography_default, {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime19.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime19.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color && (0, import_jsx_runtime19.jsx)(ChartsTooltipMark, {
                color,
                className: classes.mark
              })
            }), (0, import_jsx_runtime19.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime19.jsx)(Typography_default, {
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(NoSsr, {
    children: popperOpen && (0, import_jsx_runtime21.jsx)(PopperComponent, _extends({}, popperProps, {
      children: trigger === "item" ? (0, import_jsx_runtime21.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime21.jsx)(ChartsAxisTooltipContent, {
...
var _excluded10 = ["rotate", "dominantBaseline"];
...
function LegendPerItem(props) {
  ...
  const getItemSpace = React35.useCallback((label, inStyle = {}) => {
    const style = _objectWithoutPropertiesLoose(inStyle, _excluded10);
  ...
  return (0, import_jsx_runtime22.jsx)(NoSsr, {
    children: (0, import_jsx_runtime22.jsx)(ChartsLegendRoot, {
      ...
      children: itemsWithPosition.map(({
        ...
        positionX,
        positionY
      }) => (0, import_jsx_runtime22.jsxs)("g", {
        className: classes == null ? void 0 : classes.series,
        transform: `translate(${gapX + (isRTL ? legendWidth - positionX : positionX)} ${gapY + positionY})`,
        children: [(0, import_jsx_runtime22.jsx)("rect", {
          ...
          fill: color
        }), (0, import_jsx_runtime22.jsx)(ChartsText, {
          style: labelStyle,
          text: label,
...
var _excluded11 = ["drawingArea", "seriesToDisplay"];
function DefaultChartsLegend(props) {
  const {
    seriesToDisplay
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded11);
  return (0, import_jsx_runtime23.jsx)(LegendPerItem, _extends({}, other, {
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime25.jsxs)(React39.Fragment, {
    children: [(0, import_jsx_runtime25.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime25.jsx)(ChartsText, {
      text: text1,
    ...
    }), (0, import_jsx_runtime25.jsx)("rect", _extends({
...
var _excluded12 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter"];
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React41.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime27.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime27.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime27.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime27.jsx)(ChartsAxisHighlightPath, {
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(PieArcRoot, _extends({
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime29.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index) => {
      ...
      return (0, import_jsx_runtime29.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime31.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime31.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PiePlot(props) {
  ...
  return (0, import_jsx_runtime32.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime32.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime32.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime32.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime32.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime35.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime35.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var PieChart = React52.forwardRef(function PieChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime36.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    ...
    onHighlightChange,
    className,
    children: [(0, import_jsx_runtime36.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime36.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime36.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
    }), (0, import_jsx_runtime36.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime36.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime36.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
...
//# sourceMappingURL=chunk-DCKVRE4T.js.map
