...
function duration(start, end, unit, firstOfWeek) {
  ...
  return Math.abs(
    ...
    date_arithmetic_exports[unit](start, void 0, firstOfWeek) - // eslint-disable-next-line import/namespace
    date_arithmetic_exports[unit](end, void 0, firstOfWeek)
  );
}
...
function getTotalMin(start, end) {
  return diff2(start, end, "minutes") + getDstOffset(start, end);
}
function getMinutesFromMidnight(start) {
  var daystart = startOf(start, "day");
  return diff2(daystart, start, "minutes") + getDstOffset(daystart, start);
}
  ...
  return _createClass(Selection2, [{
    ...
    value: function emit(type) {
      ...
      handlers.forEach(function(fn2) {
        if (result === void 0) result = fn2.apply(void 0, args);
      });
      return result;
    }
  }, {
...
function getSlotMetrics(_ref2) {
  ...
  function positionFromDate(date2) {
    var diff3 = localizer.diff(start, date2, "minutes") + localizer.getDstOffset(start, date2);
  ...
  return {
    ...
    closestSlotFromDate: function closestSlotFromDate(date2) {
      ...
      if (localizer.lt(date2, start, "minutes")) return slots[0];
      if (localizer.gt(date2, end, "minutes")) return slots[slots.length - 1];
...
function Resources(resources, accessors) {
  return {
    map: function map(fn2) {
      if (!resources) return [fn2([NONE, null], 0)];
...
var TimeGrid = function(_Component) {
  ...
  return _createClass(TimeGrid2, [{
    ...
    value: function render() {
      ...
      var start = range2[0], end = range2[range2.length - 1];
...
function Agenda(_ref) {
  ...
  var timeRangeLabel = function timeRangeLabel2(day2, event) {
    ...
    if (localizer.gt(day2, start, "day")) labelClass = "rbc-continues-prior";
    if (localizer.lt(day2, end2, "day")) labelClass += " rbc-continues-after";
    return import_react25.default.createElement("span", {
  ...
  var range2 = localizer.range(date2, end, "day");
...
function moment(moment2) {
  ...
  function getTotalMin2(start, end) {
    return diff3(start, end, "minutes");
  }
  ...
  function continuesAfter2(start, end, last) {
    var mEnd = moment2(end);
    var mLast = moment2(last);
    return mEnd.isSameOrAfter(mLast, "minutes");
  }
  function daySpan2(start, end) {
    var mStart = moment2(start);
    var mEnd = moment2(end);
...
function dayjs(dayjsLib) {
  ...
  function daySpan2(start, end) {
    var startDay = dayjs2(start);
    var endDay = dayjs2(end);
